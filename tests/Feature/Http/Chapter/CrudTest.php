...
class CrudTest extends TestCase
{
    ...
    public function test_assigned_coach_can_create_chapter(): void
    {
        ...
        $this->assertDatabaseHas('chapters', ['part_id' => $part->id, 'title' => '第1章']);
    }

    public function test_non_assigned_coach_cannot_create_chapter(): void
    {
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
        $part = Part::factory()->forCertification($cert)->draft()->create();
    ...
    public function test_assigned_coach_can_publish_and_unpublish_chapter(): void
    {
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
        $this->assignCoach($coach, $cert);
    ...
    public function test_non_assigned_coach_cannot_publish_chapter(): void
    {
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
        $part = Part::factory()->forCertification($cert)->draft()->create();
        ...
        $this->actingAs($coach)
            ->postJson(route('admin.chapters.publish', $chapter))
            ->assertForbidden();
    }
    ...
    public function test_assigned_coach_can_destroy_draft_chapter(): void
    {
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
        $this->assignCoach($coach, $cert);
    ...
    public function test_non_assigned_coach_cannot_destroy_chapter(): void
    {
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
        $part = Part::factory()->forCertification($cert)->draft()->create();
